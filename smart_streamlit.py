...
filename = r'C:\ds projects\insurence_prediction\best_model.pkl'
...
st.markdown('<div class="sub-title" style="font-family: Comic Sans MS;">SMART PREMIUM</div>',unsafe_allow_html=True )
...
if st.session_state.step == 0:
    image= r'C:\ds projects\insurence_prediction\Best-Health-Insurance-Plan-Family.png'
